...
async function initLegalitas(){
 ...
 track.innerHTML=files.map((src,i)=>`<div class="legal-slide"><figure class="legal-card"><div class="legal-image"><img src="${src}" alt="Dokumen legalitas ${i+1}"></div><figcaption>Dokumen legalitas ${i+1}</figcaption></figure></div>`).join('');
